...
namespace XrmExtensions
{
    public static class ImportDetailsMapping
    {
        ...
        public const string ims_createlookuprecordname = "ims_createlookuprecordname";
        public const string ims_importdatamastername = "ims_importdatamastername";
        public const string ims_mandatoryname = "ims_mandatoryname";
        public const string ims_sourcedatatypename = "ims_sourcedatatypename";
        public const string ims_targetdatatypename = "ims_targetdatatypename";
